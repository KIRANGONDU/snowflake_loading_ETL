...
csv_df = pd.read_csv("company1.csv")
excel_df = pd.read_excel("company2.xlsx")
...
print(f"CUSTOMER_USER_DATA Loaded: {nrows} rows")
...
print(f"CUSTOMER_FINAL_DATA Loaded: {nrows} rows")
